...
public record SaveKeeperHandler(
    IKeeperRepository KeeperRepository,
    IUnitOfWork UnitOfWork) : IRequestHandler<SaveKeeper>
{
    public async Task Handle(SaveKeeper request, CancellationToken cancellationToken)
    {
