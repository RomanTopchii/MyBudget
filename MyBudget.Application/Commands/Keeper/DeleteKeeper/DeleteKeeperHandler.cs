...
public record DeleteKeeperHandler(
    IKeeperRepository KeeperRepository,
    IUnitOfWork UnitOfWork) : IRequestHandler<DeleteKeeper>
{
    public async Task Handle(DeleteKeeper request, CancellationToken cancellationToken)
    {
