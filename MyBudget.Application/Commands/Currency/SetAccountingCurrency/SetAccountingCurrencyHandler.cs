...
public record SetAccountingCurrencyHandler(
    ICurrencyRepository CurrencyRepository,
    IUnitOfWork UnitOfWork)
    : IRequestHandler<SetAccountingCurrency>
{
    public async Task Handle(SetAccountingCurrency request, CancellationToken cancellationToken)
    {
